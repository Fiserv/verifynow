...
<div>
   <input type="checkbox" class="collapsible-checkbox" id="section6">
    ...
    <p class="block-quote">📝 <em><strong>Note:</strong> <br/>API method of all Fiserv APIs is either set to POST or PUT for all operations.</p>
    ...
    <p class="block-quote">📝 <em><strong>Note:</strong> <br/>Default request-payload can be copied from the API Explorer document and you may modify certain fields as mentioned in the documentation.</p>
